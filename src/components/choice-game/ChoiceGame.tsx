  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.wrapperInfo}>
        <InformationItem size={'normal'} title={''} variant={'select'} option={template} placeholder={'Шаблон'} />
        <InformationItem size={'normal'} title={''} variant={'select'} option={year} placeholder={'Год'} />
        <InformationItem size={'normal'} title={''} variant={'select'} option={months} placeholder={'Месяц'} />
        <InformationItem size={'normal'} title={''} variant={'select'} option={group} placeholder={'Группа'} />
      </div>
      <div className={styles.innerContainer}>
        <div className={styles.stepWrapper}>
          <p>Номер урока</p>
          <div>
            <Step pageCount={4} initialPage={1} />
          </div>
        </div>
