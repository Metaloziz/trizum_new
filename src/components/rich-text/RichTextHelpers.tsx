...
import {CustomEditor, CustomElement, CustomElementAlignment, CustomElementFormat, CustomTextMark} from './RichTextTypes'

const LIST_TYPES = ['numbered-list', 'bulleted-list']
const TEXT_ALIGN_TYPES = ['left', 'center', 'right', 'justify']

export const isBlockActive = (editor: CustomEditor, format: string, blocktype: 'type' | 'align' = 'type') => {
...
type ToggleBLockProps = {editor:CustomEditor, format: CustomElementAlignment | CustomElementFormat}
