...
import { CustomEvent, CustomEventWrapper, CustomToolBar, ScheduleHeader } from '@components/schedule/ScheduleComponents'
...
const ToolBar:FC<any> = (props) => {
  ...
  const moveEvent = ({
                       ...
                       isAllDay,
                     }: {event: object, start: stringOrDate, end: stringOrDate, isAllDay: boolean}) => {
