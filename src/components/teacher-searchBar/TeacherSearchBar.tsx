  ...
  return (
    ...
    <div className={ styles.wrapper }>
      <div className={ styles.flexWrapper }>
        <InformationItem title={ 'Дата' } variant={ 'calendar' } additionalCn={ styles.flex }/>
        ...
        <div className={ styles.flex }>
          <InformationItem title={ 'ФИО франчайзи' } variant={ 'input' } additionalCn={ styles.input }/>
          <CustomSelect options={ citiesOptions } placeholder={ '' } label={ 'Юр. адрес' }
